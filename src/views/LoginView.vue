<script lang="js">
  export default {
    ...
    //   this.authUrl = 'https://account.spotify.com/authorize?response_type=code&client_id='+clientId+'&scope'+encodeURI(scope)+'&redirect_uri='+redirect_uri+'&state='+state
    ...
    <div class="auth-box">
      <div class="auth mx-auto flex max-w-sm overflow-hidden bg-white rounded-lg shadow-lg lg:max-w-4xl">
        ...
        <div class="w-full px-6 py-8 md:px-8 lg:w-1/2 flex flex-col justify-between">
          <div>
            <h2 class="text-2xl font-semibold text-center text-gray-700">Favtify</h2>
            <p class="text-xl text-center text-gray-600">Login With Spotify Account!</p>
          </div>
          <div>
            <button class="flex items-center justify-center mt-4 text-gray-600 transition-colors duration-200 transform border rounded-lg hover:bg-gray-50">
              <div class="px-4 py-2">
