      ...
      <div class="w-full md:1/2 md:h-screen md:flex md:items-center">
        <div class="relative top-0 w-full bg-gradient-to-t from-neutral-900 via-zinc-900 to-transparent">
          <div class="w-full px-6 pt-20 pb-12 md:px-8 lg:w-1/2 flex flex-col justify-between">
            ...
            <button
              class="flex items-center mx-auto px-12 justify-center mt-4 text-gray-50 transition-colors duration-200 transform border rounded-lg hover:bg-neutral-800"
              @click="authButton">
              <div class="pr-2 py-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#1DB954" class="bi bi-spotify"
                  viewBox="0 0 16 16">
                  <path
